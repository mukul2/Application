...
class SeriesShortDetailWidget extends StatefulWidget {

  Poster? poster;
  Channel? channel;


  SeriesShortDetailWidget({this.poster, this.channel});

  @override
  _MovieShortDetailWidgetState createState() => _MovieShortDetailWidgetState();
}

class _MovieShortDetailWidgetState extends State<SeriesShortDetailWidget> {
...
Future<dynamic>  searchMovieInTMDB({required String title}) async {
  ...
  print(key);
  String link = "https://api.themoviedb.org/3/tv/movie?api_key=103096910bbe8842c151f7cce00ab218&query="+key;
        ...
        children: [
          if(widget.poster != null)
            FutureBuilder<dynamic>(
              future: searchMovieInTMDB(title: widget.poster!.title), // async work
