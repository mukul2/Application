...
class SettingChooseTVTypeWidget extends StatefulWidget {
  bool isFocused = false;
  String title;
  String subtitle;
  IconData icon;
  ...
  SettingChooseTVTypeWidget({required this.isFocused, required this.title, required this.subtitle, required this.icon, required this.size});

  @override
  _SettingChooseTVTypeWidgetState createState() => _SettingChooseTVTypeWidgetState();
}

class _SettingChooseTVTypeWidgetState extends State<SettingChooseTVTypeWidget> {
  @override
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(horizontal: 7,vertical: 5),
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    width: 100,
                    child: Center(
                      child: Text( widget.size==0?"Horizontal":"Vertical",
