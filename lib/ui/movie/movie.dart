...
class _MovieState extends State<Movie> {
  ...
  return  FutureBuilder<dynamic>(
      future: getMovieDetails(title: widget.movie!.title), // async work
    ...
    if(snapshot.connectionState == ConnectionState.done  && snapshot.hasData){
      ...
      for(int i = 0 ; i < snapshot.data["genres"].length; i++){
        gg = gg+ " • "+snapshot.data["genres"][i]["name"];
        // genres = genres + " • "+g.title;
      }
      return  WillPopScope(
        onWillPop: () async{
        ...
        child: Scaffold(
          ...
          body: RawKeyboardListener(
            ...
            child: Container(
              ...
              child: Stack(
                children: [
                  FadeInImage(placeholder: MemoryImage(kTransparentImage), image: CachedNetworkImageProvider(snapshot.data["backdrop_path"]!=null?("https://image.tmdb.org/t/p/w500/"+snapshot.data["backdrop_path"]):("https://image.tmdb.org/t/p/w500/"+snapshot.data["poster_path"])),fit: BoxFit.cover,height: MediaQuery.of(context).size.height,width: MediaQuery.of(context).size.width),
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(width: 5),
                                                    Text(" •  ${snapshot.data["vote_average"]} / 10 "
                                                      , style: TextStyle(
                                                          color: Colors.white,
                                                          fontSize: 11,
                                                          fontWeight: FontWeight.w800
                                                ...
                                                SizedBox(height: 10),
                                                Text(" ${snapshot.data["runtime"]} min ${gg}"
                                                  , style: TextStyle(
                                                      color: Colors.white,
                                                      fontSize: 13,
                                                      fontWeight: FontWeight.w900
