    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body:RawKeyboardListener(
          ...
          child: false?SingleChildScrollView(child: Column(
            children: [

              Container(height: MediaQuery.of(context).size.height*0.8,child: Stack(

                children: [
                  if(!movies.isEmpty)
                    CachedNetworkImage(imageUrl:movies[_focused_poster].cover,fit: BoxFit.cover,width: MediaQuery.of(context).size.width,height: MediaQuery.of(context).size.height,fadeInDuration: Duration(seconds: 1)),
                  Container(
